...
contract AnonAbuse {
  ...
  // Getter functions
  function getLeavesFromAttackerAddress(address attacker_address) external view returns (address[] memory) {
  ...
  function getLeavesFromGroupID(uint256 groupID) external view returns (address[] memory) {
